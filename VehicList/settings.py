"""
Django settings for VehicList project.
...
ROOT_URLCONF = 'VehicList.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'FindMyCar/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'VehicList.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'FindMyCar/app_static_assets')]
STATIC_ROOT = os.path.join(BASE_DIR, 'FindMyCar/django_stored_static_assets')
